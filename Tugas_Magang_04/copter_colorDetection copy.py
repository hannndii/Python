...
# Global flag for purple detection
...
def detect_purple():
    ...
    while not purple_detected:
        ...
        # Check if purple is detected (threshold for minimum purple pixels)
        ...
        # cv2.imshow('Masked (Bukan purple)', result)
...
def main():
    # Start purple detection in separate thread
    ...
    # If purple detected, return to launch
    if purple_detected:
        return_to_launch()
