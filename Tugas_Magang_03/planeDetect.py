...
video = "D:\My Code\PYTHON\Tugas_Magang_03\Video\WhatsApp Video 2024-12-16 at 21.36.18_9b4f810f.mp4"  
...
while True:
    ...
    result = model.predict(frame, conf=0.5, show=False)
    annotated_frame = result[0].plot()  
    
    cv2.imshow("Detect Plane", annotated_frame)
